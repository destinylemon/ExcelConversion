        ...
        for (int i = 0; i < nodelist.getLength(); i++) {
            ...
            if (book.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if (element.hasAttributes()) {
                    ...
                    list.add("\"" + arrayName + (arrayIndex++) + "\":" + "\"" + exStringToJSON(book.getTextContent()) + "\"");
                }
            }
        }
        return list;
...
//	System.out.println("tagname "+root.getTagName());
    ...
    public ArrayList<StringEntry> getNodeList(String coding) {
        DocumentBuilderFactory domfac = DocumentBuilderFactory.newInstance();
...
//	System.out.println("tagname "+root.getTagName());
    ...
    //返回一个哈希表数据
    ArrayList<StringEntry> getNodeList(NodeList nodelist) {
